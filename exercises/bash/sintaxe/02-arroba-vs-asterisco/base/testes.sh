...
verificar 'contar_args tres palavras simples' '3' "$(contar_args a b c)"

# $@ sem aspas reparte "a b" em duas palavras antes de chegar em contar: a
# contagem sobe de 2 para 3.
verificar 'contar_args argumento com espaco' '2' "$(contar_args "a b" c)"
