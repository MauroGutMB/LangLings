...
# classificar diz de que lado do zero o número está.
#
# A ordem dos ramos importa menos que a exclusividade: como -lt 0 e -gt 0 não
# se sobrepõem, o else só sobra para o zero e não precisa de teste próprio.
classificar() {
  local n="$1"
  if [[ $n -lt 0 ]]; then
    echo "negativo"
