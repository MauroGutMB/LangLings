...
# etiquetar devolve o texto prefixado.
#
# As aspas em "$texto" são o que impede o Bash de quebrar o valor em palavras
# antes de o echo vê-lo: sem elas, "dois  espacos" chegaria como duas palavras
# e sairia com um espaço só.
etiquetar() {
  local texto="$1"
  echo "Nome: $texto"
}
