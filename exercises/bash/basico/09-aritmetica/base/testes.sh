...
verificar 'media 2 4 6' '4' "$(media 2 4 6)"
# 10 / 4 = 2.5, e divisão inteira trunca para baixo: 2.
verificar 'media 1 2 3 4' '2' "$(media 1 2 3 4)"
verificar 'media sem argumentos' '0' "$(media)"
verificar 'media um numero' '7' "$(media 7)"
