...
/* conceito traduz a nota na letra correspondente.
 *
 * A cadeia desce dos limites maiores para os menores porque cada else if só é
 * alcançado quando os anteriores falharam: escrita nessa ordem, cada condição
 * precisa checar apenas o piso da faixa, sem repetir o teto da anterior.
 */
