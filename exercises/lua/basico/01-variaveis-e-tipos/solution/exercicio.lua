...
-- ehInteiro pergunta pelo subtipo, não pelo tipo.
--
-- math.type devolve nil para qualquer valor que não seja número, então a
-- comparação com "integer" já cobre texto, nil e boolean sem um if extra.
