...
-- somaPares percorre só os pares em vez de testar cada número.
--
-- Começar em 2 com passo 2 dispensa o if de paridade e resolve n < 2 de
-- graça: o for com início maior que o fim não roda nenhuma vez.
