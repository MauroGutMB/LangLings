...
-- SUA VEZ
--
-- Devolva uma função que, a cada chamada sem argumento, devolve o próximo
-- inteiro: 1, depois 2, depois 3... Cada chamada a criarContador começa uma
-- contagem nova e independente das outras.
function M.criarContador()
  return function() return -1 end -- <- troque isto
end
