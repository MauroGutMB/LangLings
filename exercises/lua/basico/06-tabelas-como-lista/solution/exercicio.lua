...
-- dobrar constrói uma lista nova em vez de alterar a recebida.
--
-- Escrever em nova[i] com o mesmo índice da origem mantém a ordem sem
-- depender de contador à parte, e deixa claro que as duas listas têm o mesmo
-- tamanho.
function M.dobrar(t)
  local nova = {}
