...
-- somaEContagem devolve a soma e a quantidade de argumentos.
--
-- A contagem sai de select("#", ...) e não de #{...}: as duas dão o mesmo
-- número aqui, mas só a primeira continua certa se alguém passar nil no meio.
