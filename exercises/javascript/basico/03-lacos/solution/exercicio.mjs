...
// somarPares acumula apenas os números pares do array.
//
// O acumulador vive fora do laço porque precisa sobreviver às voltas; o teste
// de paridade usa === 0 no resto para não escorregar nos negativos, onde o
// resto é negativo em vez de 1.
