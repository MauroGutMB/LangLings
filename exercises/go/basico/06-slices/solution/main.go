...
// Pares devolve os elementos pares de xs num slice próprio.
//
// A capacidade é dimensionada pelo pior caso (todos pares) para que nenhum
// append precise realocar; o comprimento continua sendo 0, então o slice
// devolvido nunca tem buracos.
