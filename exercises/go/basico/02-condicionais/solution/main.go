...
// Faixa classifica n em três intervalos contíguos.
//
// A ordem dos cases é o que dispensa os limites inferiores: quando o segundo
// case é avaliado, n < 10 já foi descartado.
