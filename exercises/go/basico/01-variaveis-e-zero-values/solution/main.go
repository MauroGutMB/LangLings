...
//
// A soma acontece em int e só então vira float64: converter os dois lados
// antes de somar daria o mesmo resultado, mas a divisão é quem precisa ser
// feita em ponto flutuante para a fração sobreviver.
