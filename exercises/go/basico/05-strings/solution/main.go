...
// Contar devolve o número de runas de s.
//
// RuneCountInString percorre os bytes decodificando, sem alocar: []rune(s)
// daria o mesmo número, mas copiaria a string inteira só para medi-la.
